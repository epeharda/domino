...
// Global URL variable
var BASE_URL = 'http://www.leg.state.co.us/demo/iLegislate.nsf/jBill.xsp';
	...
	switch(method) {
		...
		case 'read':
			...
			if (payload[model.idAttribute]) {
				...
				http_request('GET', 'http://www.leg.state.co.us/demo/iLegislate.nsf/jBill.xsp', null, callback);
			}
